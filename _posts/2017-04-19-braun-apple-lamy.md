...
![AirPods, Lamy Safari]({{ page.imagelocation }}/braun-apple-lamy-1.jpg){:class="img-wide"}
...
![AirPods, Lamy Safari]({{ page.imagelocation }}/braun-apple-lamy-2.jpg){:class="img-wide"}
...
![AirPods, Lamy Safari]({{ page.imagelocation }}/braun-apple-lamy-3.jpg){:class="img-wide"}
